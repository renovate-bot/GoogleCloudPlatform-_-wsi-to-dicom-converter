...
const uint64_t tileIndex, std::unique_ptr<uint8_t[]> rawBuffer,
const uint64_t bufferSize) : tiffDirectory_(tiffDirectory),
tileIndex_(tileIndex), rawBufferSize_(bufferSize) {
